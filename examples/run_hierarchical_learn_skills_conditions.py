...
"""
Example running "Learning to plan hierarchically" to learn skills AND 
primitive skill success conditions from successfully completing the goals of a
curriculum.
Success conditions for primitive skills are unknown.
"""
